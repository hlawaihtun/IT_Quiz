                ...
                <div class="col-lg-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h1>Join the largest code learners's community!!</h1>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <img src="frondend/img/html.png" alt="" class="img">

                            <h4>HTML Courses</h4>
                            
                           <a href="#" class="btn_2" style="background-color: blue"> Learning Now</a>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="frondend/img/css.png" alt="" class="img">
                            <div class="css" style="">
                            <h4>CSS Courses</h4>
                            </div>
                            <a href="#" class="btn_2" style="background-color: blue"> Learning Now</a>                        
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="frondend/img/js2.png" alt="" class="img">
                            <h4>Java Script Courses</h4>
                              <a href="#" class="btn_2" style="background-color: blue">Learning Now</a>  
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="frondend/img/jq.png" alt="" class="img">
                            <h4>Jquery Courses</h4>
                             <a href="#" class="btn_2" style="background-color: blue">Learning Now</a>  
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="frondend/img/php3.png" alt="" class="img">
                            <h4>PHP Courses</h4>
                             <a href="#" class="btn_2" style="background-color: blue"> Learning Now</a>  
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="frondend/img/boot.png" alt="" class="img">
                            <h4>Bootstrap Courses</h4>
                             <a href="#" class="btn_2" style="background-color: blue">Learning Now</a>  
                        </div>
                    </div>
                </div>
                    ...
                    <div class="about_us_text">
                       <!--  <img src="frondend/img/about.png" alt="" style="width: 50px;height: 50px"> -->
                        ...
                        <p>Saw shall light. Us their to place had creepeth day
                            ...
                            all let she'd lights abundantly blessed.
                            <a href="#" >learn more</a>
                        </p>
...
<div class="feedback-section" style=" ">
  ...
  <div class="card card-image "
    style="background-image: url('frondend/img/formback.jpg');">
    <div class="text-white rgba-stylish-strong py-5 px-5 z-depth-4">

      <!--Header-->
      <div class="text-center">
        <h3 class="white-text mb-5 mt-4 font-weight-bold"><strong>Feedback</strong> <a
